...
import { verifyOrRestrict } from '../src/index';
...
describe('verifyOrRestrict', () => {
  ...
  describe('when token does not exist', () => {
    it('should merge the restriction in to the query and call find', () => {
      ...
      verifyOrRestrict({ restrict: {approved: true} }).call(mockService, hook);
    ...
    it('if hook.id is set, merge the restriction and the id into the query and call find', () => {
      ...
      verifyOrRestrict({restrict: {approved: true}, idField: '_id'}).call(mockService, hook);
